...
- There are two opportunities to present posters: online (mandatory) and onsite (optional).
    - Online presentations will be conducted by uploading files to the conference platform in advance, allowing participants to view them freely during the conference period. No core time is scheduled.
...
<tr class="header">
<th colspan=2></th>
<th><strong>Before meeting</strong></th>
...
<td>Online</td>
<td colspan=5> *Available for viewing and comments until early Apr.</td>
</tr>
<tr class="even">
<td>Onsite</td>
<td></td>
