...
発表に際しての注意点について、現時点で確定している情報のみ掲載しています。より**詳細な情報は1月頃に更新される予定**です。

## 一般口頭発表

- 一般発表における口頭発表は、いずれも**会場に設置されている発表用PCを使用**します。持ち込んだPCでの発表はできません。
...
**企画の申込に関連した注意点**については、[**「企画にあたって」**](/regist_session#企画にあたって)をご確認ください。
...
- 企画者が希望する場合、発表の様子は業者による録画が行われます。
    ...
    - 録画は会場に設置された業者のカメラで行われます。
    - 録画対象はスクリーンのスライド映像と音声で、会場の様子は撮影されません。
    - 録音は、マイクを通して話された音声のみとなります。マイクを通さない質疑応答や総合討論等での発言は録音されません。
<!-- 
...
本大会の一般公演の口頭発表では、発表者が自身の発表の様子を録画し、大会プラットフォーム上で配信できる「セルフ・オンデマンド配信」を実施します。

- 全ての一般口頭発表が対象です。各種集会では利用することはできません。
