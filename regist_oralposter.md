...
- オンラインポスター発表では、コアタイムは設定しませんが、**集中的に閲覧・議論を行っていただく「閲覧期間」を3月15-16日に設定**しています。この期間中はコメントへの対応をお願いします。
...
- ポスター賞の審査は、**3月13日(土)23:59までにアップロード**されたオンラインポスター本体を対象に行います。オンサイトでの発表および質疑応答は審査対象には含まれません。
    - 審査員がらくらくカンファレンスのコメント機能を用いて発表者に質問し、その応答をもって評価することがあります。閲覧期間（3月15-16日）は、コメントへの対応をお願いします。
- 審査対象はポスター本体のみです。グラフィカルアブストラクトの掲載は任意であり、審査対象には含まれません。

ポスター賞の審査基準は、ポスターの**情報伝達能力**と**研究の質**です。
