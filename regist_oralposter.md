...
- オンラインポスター発表は、大会プラットフォーム上にアップロードする形で実施します。コアタイムは設定しません。
    - 全てのポスターが公開される3月13日以降、大会会期中随時閲覧・議論可能です（閲覧・コメント機能は4月16日まで利用可能）。
...
- ポスター賞の審査は、**3月12日(金)23:59までにアップロード**されたオンラインポスター本体を対象に行います。
    - 審査員がらくらくカンファレンスのコメント機能を用いて発表者に質問し、その応答をもって評価することがあります。
