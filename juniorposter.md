...
　　- ポスター賞応募の有無にかかわらず、1団体から応募できる発表は4題までです。
    - ポスター賞に応募できるのは1団体あたり2題までです。
...
以下に従って、オンラインシステム上で申し込みを行ってください。

- **ジュニアポスター発表申込み・要旨登録・ポスター登録** : 生徒の発表に責任を負うことのできる教員または保護者の方（以下「申込責任者」）
- **大会参加申込み** : 発表を行う生徒、見学のみの生徒、申込責任者、申込責任者以外の引率者の全員

今大会では、大会に参加して発表を行う生徒、および申込責任者は **全員 11月2日(金)23:59 JSTまでに各自で参加申込の手続きを行う必要があります**。発表はせず、参加・見学のみ希望する生徒や申込責任者以外の引率者の大会参加登録は2026年1月6日(火)～開始します。詳細は追って掲載します。
...
### \(1\) 参加申込み（発表を行う生徒・申込責任者）

締切：**2026年11月2日(月) 23:59 JST**

オンライン・現地、いずれかでの発表を行う生徒（発表者）および申込責任者は、全員以下の手順で大会参加申込みを行ってください。本申込におけるメールアドレスの登録は、現地で使用する名札の印刷に必要となります。必ず、発表者と申込責任者の全員がそれぞれ参加申し込みを行ってください。
...
- **発表者の氏名・所属**：ここでいう「発表者」とは、必ずしもポスターの解説を行う発表担当の生徒のことではなく、発表する研究において重要な貢献をした全ての人を指します。[研究への貢献の考え方](#参考研究における著者それぞれの貢献の考え方)を参考に、発表者を決めてください。氏名・所属は日本語、英語両方の表記が必要です。
- **代表発表者**：発表者のうち一人を代表発表者として登録する必要があります。代表発表者は発表者連名の一番最初に氏名を登録してください。同一人物が複数の発表における「代表発表者」となることはできません。
- 発表者全員が生態学会での発表に同意していることを確認してください。全員の同意がなければ発表することはできません。
...
- 発表者全員分の[研究への貢献内容](#参考研究における著者それぞれの貢献の考え方)をポスターに明記してください。下部や最後のページ等、目立たない位置でかまいません
