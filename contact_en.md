...
Please contact us using the form below. We will be **out of service each night from 17:00 to 10:00 in JST.**

[\[Contact Form\]](https://otoiawase.jp/do/public/form/seitai/3)
<!--大会プラットフォーム公開後に掲載（URL等はESJ73のものなので，最新情報を要確認）
---

For inquiries related to the conference platform “Rakuraku Conference,” including system operations, please use the form available at the following link:

[【Rakuraku Conference Contact Form】](https://forms.gle/X84X6TLouz4z2w5n6)  
※ If you are unable to use this form, please send an email directly to support@gakkai.online, clearly indicating the name of the conference.
-->