...
富山国際会議場は、すべての発表会場で、有線LANおよび無線LANの利用申請を行いますので（有償・見積もり済み）、使用可能です。演者は有線LANを使えば、比較的快適な環境が確保できるかと思います。一方、無線LANは、一度に多数の方が利用した場合、どの程度の通信環境が維持できるかはわかりません。

富山県民会館および富山市民プラザは各会場で有線LANが使用できるようですが、確認いたします。これとは別に、公共無線LAN（TOYAMa Free Wi-Fi）が使用できますが、私の経験からすると、通信環境は極めて悪いです。

上記以外に、3つの会場では無料の公共無線LAN（TOYAMa Free Wi-Fi）が提供されていますが、多数の参加者が同時に接続すると通信が不安定になる可能性があります。

なお、当日の会場の電波状況・接続環境について保証するものではありません。
...
|ジュニアポスター部会|大竹裕里恵、川津一隆、鶴井香織、佐藤安弘、辻冴月、奥田圭、井上智美、榎本孝晃|
