...
**=オンラインポスター閲覧期間=**  
2027年3月15日(月) 〜 16日(火)  
※大会プラットフォーム上で、集中的にポスターの閲覧・議論をお願いしている期間です。なお、閲覧やコメント自体は4月ごろまで可能です。
...
- ポスター発表は、オンライン発表（必須）とオンサイト発表（希望者のみ）の2回の発表機会があります。
    - オンライン発表は、ファイルを事前に大会プラットフォーム上へアップロードし、参加者が大会期間中自由に閲覧する形で実施します。コアタイムは設定しませんが、**集中的に閲覧・議論を行っていただく「閲覧期間」を3月15-16日に設定**しています。
    - オンサイト発表にはコアタイムを設けます。
...
参加・発表申込みについては [**各種申込み情報**](/registinfo) をご覧ください。
...
<tr class="header">
<th colspan=2></th>
<th><strong>3月15～16日<br/>(月-火)</strong></th>
...
日本生態学会では、<a href="https://www.esj.ne.jp/esj/#diversity" target="_blank">ダイバーシティ推進宣言</a>を掲げ、多様な背景をもつ研究者の参画を奨励しています。多様な立場、ジェンダー、国籍の研究者からの意欲的な提案を期待しています。またシンポジウム・自由集会の企画者は、企画者や講演者の立場やジェンダーなどのバランスに配慮して集会を構成してください。
...
2. **ハラスメント行為の防止**  
他の参加者の活動やキャリアに害を与える行為、特定・不特定多数を問わず不快な思いをさせる行為、それらを助長する行為を含むあらゆる形態のハラスメント行為を行わない。
