...
「講演をキャンセルする」のか「大会参加自体をキャンセルする」かによって手続きが異なります。

#### 講演をキャンセルする場合

- 発表登録の締切（2026年11月2日 23時59分）前であれば、<a href="https://iap-jp.org/esj/conf/login.php" target="_blank">**各種講演申込みサイト**</a>からキャンセル操作が可能です。
- 発表登録の締切後は、**件名を「講演キャンセル（発表番号）」として**[問い合わせページ](/contact)からご連絡ください。
    - なお、プログラム及びホームページには、登録を締切時の情報がそのまま掲載されます。

#### 大会参加のみをキャンセルする場合

- **件名を「大会参加キャンセル」として**[問い合わせページ](/contact)からご連絡ください。
- 参加費の返金期限は2027年2月17日です。この日までに参加キャンセルの申し出があった場合は、振込手数料等の経費を除き返金いたします。期限を過ぎた場合は、原則として返金いたしませんので、ご注意ください。
