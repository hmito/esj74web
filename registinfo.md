...
- 大会参加または講演をキャンセルされる場合は、必ずお手続きください。
- **参加費の返金期限は 2027年2月20日<!--TODO 日程検討中、要確認--> です**。この日までに参加キャンセルの申し出があった場合は、振込手数料等の経費を除き返金いたします。期限を過ぎた場合は、原則として返金いたしませんので、ご注意ください。
- 発表登録締切後（2026年11月2日 23時59分）に講演をキャンセルした場合、プログラム及びホームページ上にはキャンセル後も登録情報がそのまま掲載されます。

#### キャンセル方法

- **件名を以下のいずれか**としたうえで、[問い合わせページ](/contact)からご連絡ください。
